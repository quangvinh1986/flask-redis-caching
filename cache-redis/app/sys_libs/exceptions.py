...
from app.libs.common.http_code import HTTP_STATUS_CODES
from app.libs.common.error_code import *

from app.libs.common.utils import send_result, send_error
...
def api_error_handler(error):
    if isinstance(error, HTTPException):
        ...
        if not isinstance(error.description, dict):
            if code == 422:
                ...
                error.description = get_error_message(data)
            else:
    ...
    return send_error(message=error_msg, code=code)
